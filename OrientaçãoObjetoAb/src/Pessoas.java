...
public class Pessoas {
	...
	void receber( int numFigurinhas) {
		...
		this.numFigurinhas +=  numFigurinhas;	//soma o valor	// O this é usado para referenciar a um atributo externo fora do metodo. Por exemplo ser dentro de um método se estiver
													//dois atributos com o mesmo nome oque estiver com a palavra "this" estará se referenciando a um atributo fora do metodo.
