...
public class Aplicacao {
	...
	public static void main(String[] args) {
		...
		Data d1 = new Data(10, 03, 2000, 0, 30, 10);// O objeto foi criado para colocar o endereço no objeto "Data() = É o construtor"
		 d1.imprimir(Data.FORMATO_12H);
		 d1.imprimir(Data.FORMATO_24H); //Usando o metodo criado anteriormente
